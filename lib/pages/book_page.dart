import 'package:badges/badges.dart' as badges; // Aliased as 'badges'
...
class _BookPageState extends State<BookPage> {
  ...
  // new method to encapsulate the body of the widget
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              SizedBox(width: 15),
              badges.Badge(  // Aliased to avoid naming conflict
  ...
  List<Widget> getNewBooks() {
    return List.generate(
      latestBooks.length,
      (index) => BookItem(book: latestBooks[index]),
    );
  }
  ...
  List<Widget> getPopularBooks() {
    return List.generate(
      popularBooks.length,
      (index) => BookItem(book: popularBooks[index]),
    );
  }
}
